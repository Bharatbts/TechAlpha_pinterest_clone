                            ...
                            {currentHeadingIndex === headingIndex && (
                                ...
                                >
                                    <TileColumn margin={margin}>
                                        <Tile src={`/${HEADINGS[currentHeadingIndex].section}/${HEADINGS[currentHeadingIndex].section}-${index * 2}.jpeg`} />
                                        <Tile src={`/${HEADINGS[currentHeadingIndex].section}/${HEADINGS[currentHeadingIndex].section}-${index * 2 + 1}.jpeg`} />
                                    </TileColumn>
                                </AnimatedColumn>
                            )}
                        </AnimatePresence>
